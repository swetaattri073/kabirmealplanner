 ...
 * Default / production: http://littlebowl.in/home (app entry, not marketing /)
 *
 * Usage:
 *   npm run configure
...
function normalizeUrl(raw) {
  ...
  // Bare origin → app entry (/home), matching PWA start_url
  try {
    const u = new URL(url);
...
fs.writeFileSync(
  webConfigPath,
  `// Production LittleBowl backend — baked into the native apps.\n` +
...
console.log('No first-launch URL prompt — this is the production app endpoint.');
